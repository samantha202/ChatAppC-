...
namespace Client
{
    ...
    {
        TcpClient clientSocket = new TcpClient();//client connection for TCP network services
        String friend, myName;
        Thread ctThread;
        NetworkStream serverStream = default(NetworkStream);//Provides the underlying data flow for network access
